...
app.get('/', (req, res) => {
    ...
    <h1>Hotel Booking System</h1>
        ...
        <div>
            ...
            <input type="number" name="room_no" value="" id="room_no" required>
        </div>
        <div>
        ...
        <div>
            ...
            <form action="/checkout/insert" method="post">
            <h2> ADD CHECKOUT DETAILS</h2>
            <div>
            ...
            <div>
            <h2> VIEW UNALLOTTED ROOOMS</h2>
                <form action="/unoccupied" method="get">
                <input type="submit" value="VIEW UNOCCUPIED ROOMS">
                </form>
            </div>
            ...
            <hr>
                ...
                <form action="/occupied" method="get">
                <h2> VIEW ALLOTTED ROOOMS</h2>
                    <div>
                        <button type="submit">VIEW OCCUPIED ROOMS</button>
                    </div>
                </form>
